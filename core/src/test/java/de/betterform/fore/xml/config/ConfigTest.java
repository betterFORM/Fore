...
*/
        ...
        assertTrue("uri-resolver 'file' is wrong",
                value.equals("de.betterform.fore.connector.file.FileURIResolver"));
        ...
        assertTrue("submission-handler 'file' is wrong" + ": " + value,
                value.equals("de.betterform.fore.connector.file.FileSubmissionHandler"));
        ...
        assertTrue("submission-handler 'http' is wrong" + ": " + value,
                value.equals("de.betterform.fore.connector.http.HTTPSubmissionHandler"));
        ...
        assertTrue("submission-handler 'mailto' is wrong" + ": " + value,
                value.equals("de.betterform.fore.connector.smtp.SMTPSubmissionHandler"));
    }
