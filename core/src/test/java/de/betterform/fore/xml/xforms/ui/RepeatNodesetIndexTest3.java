 ...
 *          <tr>
 *              <td>
 *                  <div xf:repeat-nodeset="">
 *                      ....
 *
 * @author Tobi Krebs&eacute;
 * @version $Id: RepeatNodesetIndexTest3.java $
 */
public class RepeatNodesetIndexTest3 extends RepeatIndexTest {
    /**
     * Sets up the test.
     *
    ...
    protected void setUp() throws Exception {
        ...
        this.xformsProcesssorImpl.setXForms(getClass().getResourceAsStream("RepeatNodesetIndexTest3.xhtml"));
        ...
        //tbody -> tbody
        //this.enclosingRepeat = (Repeat) this.xformsProcesssorImpl.getContainer().lookup(XPathUtil.evaluateAsString(host, "//html:tbody[@xf:repeat-nodeset][1]/@id"));
        //this.nestedRepeat1 = (Repeat) this.xformsProcesssorImpl.getContainer().lookup(XPathUtil.evaluateAsString(host, "descendant::html:tbody[@xf:repeat-nodeset][2]/@id"));
        //this.nestedRepeat2 = (Repeat) this.xformsProcesssorImpl.getContainer().lookup(XPathUtil.evaluateAsString(host, "descendant::html:tbody[@xf:repeat-nodeset][3]/@id"));
        //this.nestedRepeat3 = (Repeat) this.xformsProcesssorImpl.getContainer().lookup(XPathUtil.evaluateAsString(host, "descendant::html:tbody[@xf:repeat-nodeset][4]/@id"));
        //tbody -> div
        this.enclosingRepeat = (Repeat) this.xformsProcesssorImpl.getContainer().lookup(XPathUtil.evaluateAsString(host, "//html:tbody[@xf:repeat-nodeset][1]/@id"));
        this.nestedRepeat1 = (Repeat) this.xformsProcesssorImpl.getContainer().lookup(XPathUtil.evaluateAsString(host, "descendant::html:div[@xf:repeat-nodeset][1]/@id"));
        this.nestedRepeat2 = (Repeat) this.xformsProcesssorImpl.getContainer().lookup(XPathUtil.evaluateAsString(host, "descendant::html:div[@xf:repeat-nodeset][2]/@id"));
        this.nestedRepeat3 = (Repeat) this.xformsProcesssorImpl.getContainer().lookup(XPathUtil.evaluateAsString(host, "descendant::html:div[@xf:repeat-nodeset][3]/@id"));
