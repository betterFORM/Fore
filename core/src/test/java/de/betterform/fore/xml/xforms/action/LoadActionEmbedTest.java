...
//    }
    ...
    public void testLoadEmbedForms() throws Exception{
        ...
        assertEquals("", "boolean", XPathUtil.evaluateAsString(xformDoc, "//xf:input[1]/bf:data/@type"));
        assertEquals("", "2009-10-01", XPathUtil.evaluateAsString(xformDoc, "//xf:input[2]/bf:data/@schema-value"));
        assertEquals("", "date", XPathUtil.evaluateAsString(xformDoc, "//xf:input[2]/bf:data/@type"));
        assertEquals("", "2009-10-01", XPathUtil.evaluateAsString(xformDoc, "//xf:input[3]/bf:data/@schema-value"));
        assertEquals("", "date", XPathUtil.evaluateAsString(xformDoc, "//xf:input[3]/bf:data/@type"));
