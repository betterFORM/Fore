...
import de.betterform.fore.xml.xforms.exception.XFormsSubmitError;
...
//    }
    ...
    public void testCreateSubmissionHandler() throws Exception {
        ...
        assertEquals("de.betterform.fore.connector.ConnectorFactoryTestSubmissionHandler", handler.getClass().getName());
    ...
    public void testCreateURIResolver() throws Exception {
        ...
        assertEquals("de.betterform.fore.connector.ConnectorFactoryTestURIResolver", resolver.getClass().getName());
    ...
    public void testCreateDefaultFactory() throws Exception {
        ...
        assertTrue("Default Connector factory wrong",
                connectorFactory instanceof de.betterform.fore.connector.DefaultConnectorFactory);
    }
