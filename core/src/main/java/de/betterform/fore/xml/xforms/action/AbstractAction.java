...
import de.betterform.fore.xml.events.XMLEventConstants;
...
import de.betterform.fore.xml.xforms.ui.Group;
import de.betterform.fore.xml.xforms.ui.Item;
import de.betterform.fore.xml.xforms.ui.RepeatItem;
        ...
        if (!(getParentObject() instanceof XFormsAction)) {
            ...
            if(eventTargetId != null && !(eventTargetId.equals(""))){
            	...
            	if (xformsElement != null) {
                    ...
                    targetElement = (EventTarget) de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(XPathUtil.evaluate(container.getDocument(), "//*[@id = '" + eventTargetId + "']"), 1);
            ...
            if(observer != null && !(observer.equals(""))){
            	...
            	if (xformsElement != null) {
            		...
            		// In some cases the xforms element isn't registered yet (e.g.: action refers to an Instance, or a forward reference)
                    targetElement = (EventTarget) de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(XPathUtil.evaluate(container.getDocument(), "//*[@id = '" + observer + "']"), 1);
                    if(targetElement==null){
