...
//            }
    ...
    public Iterator iterateModelItems(List nodeset, boolean deep) {
        ...
        for (int i = 0; i < nodeset.size(); ++i) {
            Node node =  de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(nodeset, i + 1);
...
//            item.setNode(node);
    ...
    public List getInstanceNodeset() {
        ...
        return de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getRootContext(instanceDocument,baseURI);
    }
