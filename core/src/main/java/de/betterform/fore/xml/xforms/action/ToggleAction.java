...
import de.betterform.fore.xml.xforms.ui.Case;
...
public class ToggleAction extends AbstractAction {
    ...
    public void perform() throws XFormsException {
        ...
        if(isRepeated()) {
            ...
            Node caseNode = de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(XPathUtil.evaluate(repeatItem.getElement(), ".//*[@caseId='"+ caseId.getValue() + "']"), 1);
            if(caseNode != null) {
