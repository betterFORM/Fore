...
import de.betterform.fore.xml.xforms.ui.Output;
...
public class MessageAction extends AbstractBoundAction {
    ...
    public void perform() throws XFormsException {
        ...
        if (bindAttribute != null || refAttribute != null) {
            ...
            updateXPathContext();
            message = this.model.getInstance(getInstanceId()).getNodeValue(de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(this.nodeset, 1));
        }
