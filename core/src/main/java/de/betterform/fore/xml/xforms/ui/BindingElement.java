...
import de.betterform.fore.xml.xforms.model.bind.Binding;
import de.betterform.fore.xml.xforms.model.bind.BindingResolver;
...
public abstract class BindingElement extends AbstractUIElement implements Binding, DefaultAction {
    ...
    public Node getInstanceNode() throws XFormsException {
         return de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(getNodeset(), getPosition());
    }
...
//        }
    ...
    public String getNodeValue() throws XFormsException {
        return this.model.getInstance(this.instanceId).getNodeValue(de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(getNodeset(), getPosition()));
    }

    public void setNodeValue(String value) throws XFormsException {
        this.model.getInstance(this.instanceId).setNodeValue(de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(getNodeset(), getPosition()), value);
    }

    public ModelItem getModelItem() {
        return this.model.getInstance(this.instanceId).getModelItem(de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(getNodeset(), getPosition()));
    }
