    ...
    public void perform() throws XFormsException {
    	...
    	if (this.atAttribute == null) {
    		...
    		for (int i = 0; i < this.nodeset.size(); i++) {
                ...
                if(!(instance.deleteNode(de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(this.nodeset, i + 1), path))) return;
			}
	        ...
	        if (this.atAttribute.equals("last()")) {
	        	...
	        	target = (Node) de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(this.nodeset, nrOfNodesInNodeset);
                ...
                */
	            ...
	            target = de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(this.nodeset, (int)position);
