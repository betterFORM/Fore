...
import de.betterform.fore.xml.events.impl.XercesXMLEvent;
import de.betterform.fore.xml.ns.NamespaceConstants;
import de.betterform.fore.xml.xforms.XFormsElement;
import de.betterform.fore.xml.xforms.XFormsElementFactory;
...
import de.betterform.fore.xml.xforms.ui.state.RepeatElementState;
...
public class Repeat extends BindingElement implements EventListener {
    ...
    private boolean doHandleInstanceEvent(Event event) throws XFormsException {
        ...
        String canonicalPath = BindingResolver.getCanonicalPath(de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(getNodeset(), getPosition()));
