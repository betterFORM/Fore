...
//            String currentValue = (String) argument[0].evaluateAsString(xpathContext);
            ...
            de.betterform.fore.xml.xforms.model.Instance owner = (de.betterform.fore.xml.xforms.model.Instance) node.getOwnerDocument().getDocumentElement().getUserData("instance");
