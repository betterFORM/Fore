...
import de.betterform.fore.xml.xforms.Container;
...
import de.betterform.fore.xml.xforms.model.bind.BindingUtil;
...
public class InsertAction extends AbstractBoundAction {
	...
	private class InsertAction10 implements IInsertAction{
		...
		public void perform() throws XFormsException {
			...
			final Node parentNode = de.betterform.fore.xml.xpath.impl.saxon.XPathUtil
					.getAsNode(InsertAction.this.nodeset, getPosition()).getParentNode();
			final Node originNode;
			if (this.originAttribute == null) {
				originNode = de.betterform.fore.xml.xpath.impl.saxon.XPathUtil
			...
			Node beforeNode = insertPosition > contextSize ? (null)
					: de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(
							InsertAction.this.nodeset, (int) insertPosition);
			if (beforeNode == null && contextSize > 0) {
				beforeNode = de.betterform.fore.xml.xpath.impl.saxon.XPathUtil
	...
	private class InsertAction11 extends InsertAction10 {
		...
		public void perform() throws XFormsException {
	        ...
	        if(nodeSetBindingNodeSet.isEmpty() && (getContextExpression() == null|| (getContextExpression() != null && !(de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(InsertAction.this.evalInscopeContext, 1) instanceof Element)))) {
	        ...
	        if (!hasNodeSetBinding || InsertAction.this.nodeset.isEmpty()) {
	        	insertLocationNode = de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(InsertAction.this.evalInscopeContext, 1);
	        	...
	        	insertLocationNode = de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(InsertAction.this.nodeset, insertPositionFirstNode);
	        }
	        ...
	        for(int i = 0; i < originNodeSet.size(); ++i) {
				Node originNode = de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(originNodeSet, i + 1);
		        ...
		        if (!hasNodeSetBinding || InsertAction.this.nodeset.isEmpty()) {
		        	parentNode = de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getAsNode(InsertAction.this.evalInscopeContext, 1);
