...
import de.betterform.fore.xml.events.XMLEventService;
...
import de.betterform.fore.xml.xforms.ui.Switch;
...
//        checkVersionCompatibility();
    ...
    public BetterFormXPathContext getHostContext(String baseURI) {
        ...
        if (this.hostContext == null) {
            List nodes = de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getRootContext(document, baseURI);
