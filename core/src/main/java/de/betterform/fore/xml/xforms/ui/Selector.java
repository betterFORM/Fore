...
public class Selector extends AbstractFormControl {
    ...
    public void performDefault(Event event) {
        ...
        List elemContext = de.betterform.fore.xml.xpath.impl.saxon.XPathUtil.getElementContext(getElement(), container.getProcessor().getBaseURI());
    ...
    public void setValue(String value) throws XFormsException
    {
        if(hasBindingExpression()) {
            ...
            de.betterform.fore.xml.xforms.XFormsElement xfe = null;
            if (values.length == 1) {
